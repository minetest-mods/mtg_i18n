...
desc("butterflies:butterfly_red", S("Red Butterfly"))
desc("butterflies:butterfly_violet", S("Violet Butterfly"))
desc("butterflies:butterfly_white", S("White Butterfly"))
...
desc("default:blueberry_bush_leaves", S("Blueberry Bush Leaves"))
desc("default:blueberry_bush_leaves", S("Blueberry Bush Leaves"))
desc("default:blueberry_bush_leaves_with_berries", S("Blueberry Bush Leaves with Berries"))
desc("default:blueberry_bush_sapling", S("Blueberry Bush Sapling"))
...
desc("default:dirt_with_coniferous_litter", S("Dirt with Coniferous Litter"))
...
desc("default:dry_dirt", S("Dry Dirt"))
desc("default:dry_dirt_with_dry_grass", S("Dry Dirt with Dry Grass"))
...
desc("default:emergent_jungle_sapling", S("Emergent Jungle Tree Sapling"))
...
desc("default:fence_rail_acacia_wood", S("Acacia Wood Fence Rail"))
desc("default:fence_rail_aspen_wood", S("Aspen Wood Fence Rail"))
desc("default:fence_rail_junglewood", S("Jungle Wood Fence Rail"))
desc("default:fence_rail_pine_wood", S("Pine Wood Fence Rail"))
desc("default:fence_rail_wood", S("Apple Wood Fence Rail"))
desc("default:fence_wood", S("Apple Wood Fence"))
desc("default:fern_1", S("Fern"))
...
desc("default:large_cactus_seedling", S("Large Cactus Seedling"))
...
desc("default:permafrost", S("Permafrost"))
desc("default:permafrost_with_moss", S("Permafrost with Moss"))
desc("default:permafrost_with_stones", S("Permafrost with Stones"))
...
desc("default:pine_bush_needles", S("Pine Bush Needles"))
desc("default:pine_bush_sapling", S("Pine Bush Sapling"))
desc("default:pine_bush_stem", S("Pine Bush Stem"))
...
desc("doors:japanese_door", S("Japanese Door"))
desc("doors:prison_door", S("Prison Door"))
desc("doors:rusty_prison_door", S("Rusty Prison Door"))
desc("doors:screen_door", S("Screen Door"))
...
desc("fireflies:bug_net", S("Bug Net"))
desc("fireflies:firefly", S("Firefly"))
desc("fireflies:firefly_bottle", S("Firefly in a Bottle"))
...
desc("map:mapping_kit", S("Mapping Kit\nUse with 'Minimap' key"))
...
desc("stairs:slab_glass", S("Glass Slab"))
...
desc("stairs:slab_obsidian_glass", S("Obsidian Glass Slab"))
...
desc("stairs:stair_glass", S("Glass Stair"))
...
desc("stairs:stair_inner_glass", S("Inner Glass Stair"))
...
desc("stairs:stair_inner_obsidian_glass", S("Inner Obsidian Glass Stair"))
...
desc("stairs:stair_obsidian_glass", S("Obsidian Glass Stair"))
...
desc("stairs:stair_outer_glass", S("Outer Glass Stair"))
...
desc("stairs:stair_outer_obsidian_glass", S("Outer Obsidian Glass Stair"))
...
desc("tnt:tnt", S("TNT"))
desc("tnt:tnt_stick", S("TNT Stick"))
...
desc("xpanes:door_steel_bar", S("Steel Bar Door"))
desc("xpanes:obsidian_pane_flat", S("Obsidian Glass Pane"))
desc("xpanes:pane", S("Glass Pane"))
desc("xpanes:pane_flat", S("Glass Pane"))
desc("xpanes:trapdoor_steel_bar", S("Steel Bar Trapdoor"))
