local S = minetest.get_translator("mtg_i18n")
...
desc("default:fern_2", S("Fern"))
desc("default:fern_3", S("Fern"))
...
desc("default:marram_grass_1", S("Marram Grass"))
desc("default:marram_grass_2", S("Marram Grass"))
desc("default:marram_grass_3", S("Marram Grass"))
